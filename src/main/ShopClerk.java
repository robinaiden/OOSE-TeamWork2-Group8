...
public class ShopClerk {
	...
	public static void main(String[] args) {
		...
		TeaFactory teafactory1 = new BlackTeaFactory();
		teafactory1.orderTea();
		
		System.out.println("Customer wants to add some Decorator:");
		TeaComponent aTea1 = new BlackTeaFactory();
		...
		TeaFactory teafactory2 = new GreenTeaFactory();
		teafactory2.orderTea();
		
		System.out.println("Customer wants to add some Decorator:");
		TeaComponent aTea2 = new GreenTeaFactory();
		...
		TeaFactory teafactory3 = new LemonTeaFactory();
		teafactory3.orderTea();
		
		System.out.println("Customer wants to add some Decorator:");
		TeaComponent aTea3 = new LemonTeaFactory();
